...
export default function Test() {
  ...
  const handleRegister = () => {
    ...
    api
      .post("register/", port, { username: "test2", password: "test2" })
      .then((res) => {
  ...
  const handleLogin = () => {
    console.log("login");
    api
      .post("login/", port, { username: "test2", password: "test2" })
      .then((res) => {
        console.log("response", res.data);
  ...
  const handlePost = (e) => {
    ...
    api
      .post("post/", port, { message: postText })
      .then((res) => {
        console.log("response", res.data);
      })
      .catch((err) => {
  ...
  const handleFollow = (e) => {
    ...
    api
      .post("follow/", port, { username: "test2" })
      .then((res) => {
        console.log("response", res.data);
      })
      .catch((err) => {
