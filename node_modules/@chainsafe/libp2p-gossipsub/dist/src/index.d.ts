...
import { MsgIdFn, TopicStr, MsgIdStr, PeerIdStr, FastMsgIdFn, AddrInfo, DataTransform, MsgIdToStrFn } from './types.js';
...
export declare class GossipSub extends EventEmitter<GossipsubEvents> implements PubSub<GossipsubEvents> {
     ...
     */
    publish(topic: TopicStr, data: Uint8Array): Promise<PublishResult>;
    /**
